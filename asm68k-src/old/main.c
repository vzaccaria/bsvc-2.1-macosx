 ...
 *
 ******************************************************************************
 * $Id: main.c,v 1.1 1996/08/02 14:44:06 bwmott Exp $
 *****************************************************************************/
...
char *argv[];
{
char fileName[64], outName[64], *p, *skipSpace(), *strchr();
int i;
...
int getoptions(argc, argv, optstring, argi)
int argc;
char *argv[];
char *optstring;
int *argi;
